...
@ManagedBean(name = "mbConsigneVol")
@ViewScoped
public class ConsigneVolManagedBean implements Serializable{
	...
	public void majConsigne() {
		...
		consignes = proxyConsigneBu.afficherConsigneParType("Vol");
		activeTabIndex = 1;
	}
	...
	public void ajouterConsigne() {
		...
		TypeConsigne Vol = new TypeConsigne();
		Vol.setId(1);
		nouvelleConsigne.setTypeConsigne(Vol);
